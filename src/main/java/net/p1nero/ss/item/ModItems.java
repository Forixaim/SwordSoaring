...
public class ModItems {
    ...
    public static final RegistryObject<Item> SHATTERED_STAR = ITEMS.register("shattered_star", () -> new ModWeaponItem(Tiers.NETHERITE, 3, -2, (new Item.Properties()).rarity(Rarity.EPIC)));
